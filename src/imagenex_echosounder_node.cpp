...
public:
  ...
  public:
    ...
    void check()
    {
      ...
      if(max_range < 5.0) max_range = 5.0;
      else if (max_range < 10.0) max_range = 10.0;
      else if (max_range < 20.0) max_range = 20.0;
      else if (max_range < 30.0) max_range = 30.0;
      else if (max_range < 40.0) max_range = 40.0;
      else max_range = 50.0;
...
private:
  ...
  void set_buffer()
  {
    ...
    buffer_tx[19] = conf.data_points; //Data Points: 25=250 points 'IMX'
    buffer_tx[20] = 0;
    buffer_tx[21] = 0;
